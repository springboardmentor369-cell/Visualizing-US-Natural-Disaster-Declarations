...
* I gained hands-on experience using Power Query to remove errors, handle missing values, and structure data.
* I realized the importance of correct data types for calculations and analysis.
* I learned that Applied Steps help track all transformations and automatically update the data during refresh.
